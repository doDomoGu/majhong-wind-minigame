...
export function seatedIds(seats) {
  if (!seats) {
    return [];
  }
...
export function applyRiichi(game, playerId) {
...
export function cancelRiichi(game, playerId) {
  if (!game || game.phase !== 'playing') {
...
export function startSettle(game, seats, kind, dealerFlag) {
  if (!game || game.phase !== 'playing') {
...
export function submitSettle(game, seats, playerId, value) {
  if (!game || !game.settle) {
...
export function computeResults(game, seats) {
